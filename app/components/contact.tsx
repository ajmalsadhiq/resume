    ...
    <section id="contact" className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-6" ref={ref}>
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-border/70 bg-card/30 p-8 backdrop-blur-xl md:p-12 lg:p-16 shadow-2xl shadow-primary/5"
        >
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-pretty leading-relaxed text-sm text-muted-foreground">
            ...
            <div className="flex flex-col gap-4 lg:col-span-2">
              {contactInfo.map((info, i) => (
                <motion.div
                  ...
                  className="group flex items-center gap-4 rounded-xl border border-border/60 bg-background/30 p-4 transition-all duration-300 hover:border-primary/40 hover:shadow-md hover:shadow-primary/5"
                >
            ...
            >
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-border/80 bg-background/25 px-4 py-3 text-sm text-foreground outline-none backdrop-blur-sm transition-colors placeholder:text-muted-foreground/60 focus:border-primary focus:ring-1 focus:ring-primary"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required 
                  className="w-full resize-none rounded-lg border border-border/80 bg-background/25 px-4 py-3 text-sm text-foreground outline-none backdrop-blur-sm transition-colors placeholder:text-muted-foreground/60 focus:border-primary focus:ring-1 focus:ring-primary"
                />
              </div>
              <motion.button
                type="submit"
